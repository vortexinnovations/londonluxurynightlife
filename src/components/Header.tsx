      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          <Link href="/" className="flex flex-col">
            <span className="font-serif text-lg lg:text-xl font-bold text-cream tracking-wide">
              London Luxury Nightlife
            </span>
            <span className="text-[10px] lg:text-xs text-warm-gray tracking-[0.2em] uppercase">
              The Insider&apos;s Guide
            </span>
          </Link>
          ...
          <div className="hidden lg:block">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gold/10 border border-gold/30 text-gold text-sm rounded hover:bg-gold/20 transition-colors"
            >
              <WhatsAppIcon />
              Speak to Our Team
            </a>
