...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://londonluxurynightlife.com/blog/scotch-of-st-james-history-legacy",
  },
};

export default function ScotchOfStJamesHistoryLegacyPage() {
  return (
    <>
      <ArticleSchema
      ...
      >
        ...
        <h2>The 1960s: Where It All Began</h2>

        <p>
          Scotch of St James opened in the mid-1960s as a music club in the
        ...
        <p>
          ...
          paid appearance fees. That authenticity attracted other musicians,
          which attracted the fashionable crowd, which created the atmosphere
          that made Scotch legendary.
        </p>

        <p className="pull-quote">
          Scotch of St James earned its reputation not through marketing but
          through decades of musicians choosing it as their own. That kind of
          credibility cannot be purchased or manufactured.
        </p>

        <h2>The Decades Between</h2>

        <p>
          The story of most 1960s venues is a story of decline. The scene
          moved on, the original crowd aged out, and the venues either closed
          or became parodies of themselves. Scotch navigated this differently.
          Through the punk era, the new wave years, Britpop, and the rise of
        ...
        <p>
          This survival required a delicate balance. Too much change and the
          venue loses its soul. Too little and it becomes a museum. Scotch
          managed to stay contemporary without becoming trendy, relevant
          without being desperate, and exclusive without being exclusionary.
          Very few venues in any city can claim a similar trajectory.
        </p>
        ...
        <p>
          ...
          than their following, which creates sets that surprise and reward
          attention.
        </p>

        <p>
          The crowd is equally eclectic. You will find musicians and music
        ...
        <p>
          In an era of identikit nightclubs designed by the same interior
          firms, staffed by the same PR companies, and playing the same
          commercial playlists, Scotch of St James stands apart by being
          irreducibly itself. You cannot franchise this. You cannot replicate
          a venue that Hendrix played in by building a new room and hanging
          vintage guitars on the wall. Authenticity of this kind is the
          rarest commodity in nightlife.
        </p>

        <p>
          For visitors to London, Scotch offers something none of the newer
          Mayfair venues can: a connection to the city&apos;s cultural history
          that is genuine rather than curated. For our{" "}
        ...
        <ul>
          <li>
            <Link href="/clubs/scotch-of-st-james">
              Scotch of St James: Full Venue Profile
            </Link>
          </li>
          <li>
