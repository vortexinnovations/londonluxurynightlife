  ...
  return (
    <>
      ...
      <ArticleLayout
        ...
        heroImage={GUIDE_IMAGES["complete-guide-london-luxury-nightlife"]}
        heroAlt="Complete guide to London luxury nightlife featuring Mayfair's exclusive club scene"
